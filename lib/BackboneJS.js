...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('underscore'), require('jQuery')) :
	typeof define === 'function' && define.amd ? define(['underscore', 'jQuery'], factory) :
	(global.Backbone = global['Backbone'] = factory(global._,global.$));
...
_.extend(Model.prototype, Events, {
  ...
  set: function set(key, val, options) {
    ...
    var attrs;
    if ((typeof key === 'undefined' ? 'undefined' : _typeof$1(key)) === 'object') {
      attrs = key;
      options = val;
    } else {
      (attrs = {})[key] = val;
  ...
  save: function save(key, val, options) {
    // Handle both `"key", value` and `{key: value}` -style arguments.
    var attrs;
    if (key == null || (typeof key === 'undefined' ? 'undefined' : _typeof$1(key)) === 'object') {
      attrs = key;
      options = val;
    } else {
      (attrs = {})[key] = val;
...
var urlError$2 = function urlError$2() {
  throw new Error('A "url" property or function must be specified');
};
...
// Useful when interfacing with server-side languages like **PHP** that make
// it difficult to read the body of `PUT` requests.
var sync$1 = function sync$1(method, model, options) {
  ...
  if (!options.url) {
    params.url = _.result(model, 'url') || urlError$2();
  }
...
_.each([[Collection, collectionMethods, 'models'], [Model, modelMethods, 'attributes']], function (config) {
  ...
  Base.mixin = function (obj) {
    var mappings = _.reduce(_.functions(obj), function (memo, name$$1) {
      memo[name$$1] = 0;
      return memo;
    }, {});
...
Backbone$1.sync = sync$1;
Backbone$1.ajax = ajax;
...
//# sourceMappingURL=BackboneJS.js.map
